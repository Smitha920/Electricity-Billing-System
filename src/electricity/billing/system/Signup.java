...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        super("Signup Page");
        getContentPane().setBackground(new Color(114, 160, 230));
        ...
        create.setBackground(new Color(68, 129, 221));
        create.setForeground(Color.black);
        create.setBounds(50,285,100,25);
        create.addActionListener(this);
        add(create);
        back = new JButton("Back");
        back.setBackground(new Color(68, 129, 221));
        ...
        boyLabel.setBounds(320,20,250,250);
        add(boyLabel);
        setSize(600,380);
        setLocation(500,200);
        setLayout(null);
